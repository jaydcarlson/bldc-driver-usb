...
#define BitIoLdd6_MODULE_BASE_ADDRESS PTC_BASE_PTR /*!< Name of macro used as the base address */
#define BitIoLdd6_PORTCONTROL_BASE_ADDRESS PORTC_BASE_PTR /*!< Name of macro used as the base address */
#define BitIoLdd6_PORT_MASK 0x0100U    /*!< Mask of the allocated pin from the port */
