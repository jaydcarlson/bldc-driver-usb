...
LDD_TDeviceData* ExtIntLdd1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* PORTA_PCR5: ISF=0,IRQC=0x0B,MUX=1 */
...
void ExtIntLdd1_Enable(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  PORT_PDD_SetPinInterruptConfiguration(PORTA_BASE_PTR,
    ExtIntLdd1_PIN_INDEX, DeviceDataPrv->IrqConfig);
}
...
LDD_TError ExtIntLdd1_SetEdge(LDD_TDeviceData *DeviceDataPtr, uint8_t Edge)
{
  ...
  PORT_PDD_SetPinInterruptConfiguration(PORTA_BASE_PTR, ExtIntLdd1_PIN_INDEX, Config);
