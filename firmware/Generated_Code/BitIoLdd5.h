...
**          Pin for I/O                                    : PTE1/LLWU_P0/UART1_RX
**          Pin signal                                     : 
**          Direction                                      : Input
**          Initialization                                 : 
...
*/         
/*!
**  @addtogroup BitIoLdd5_module BitIoLdd5 module documentation
**  @{
*/         
...
#define BitIoLdd5_Init_METHOD_ENABLED  /*!< Init method of the component BitIoLdd5 is enabled (generated) */
#define BitIoLdd5_GetVal_METHOD_ENABLED /*!< GetVal method of the component BitIoLdd5 is enabled (generated) */

/* Definition of implementation constants */
#define BitIoLdd5_MODULE_BASE_ADDRESS PTE_BASE_PTR /*!< Name of macro used as the base address */
#define BitIoLdd5_PORTCONTROL_BASE_ADDRESS PORTE_BASE_PTR /*!< Name of macro used as the base address */
#define BitIoLdd5_PORT_MASK 0x02U      /*!< Mask of the allocated pin from the port */
