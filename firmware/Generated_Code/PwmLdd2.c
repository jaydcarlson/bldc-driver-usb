...
LDD_TDeviceData* PwmLdd2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->RatioStore = 0xFE3DU; /* Ratio after initialization */
...
LDD_TError PwmLdd2_SetDutyUS(LDD_TDeviceData *DeviceDataPtr, uint16_t Time)
{
  ...
  rtval = Time * 21845.333333333332F;  /* Multiply given value and actual clock configuration coefficient */
