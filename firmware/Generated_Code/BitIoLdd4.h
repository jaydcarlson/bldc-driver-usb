...
**          Pin for I/O                                    : PTE0/UART1_TX/RTC_CLKOUT
**          Pin signal                                     : 
**          Direction                                      : Input
**          Initialization                                 : 
...
#define BitIoLdd4_PRPH_BASE_ADDRESS  0x400FF100U
...
#define BitIoLdd4_MODULE_BASE_ADDRESS PTE_BASE_PTR /*!< Name of macro used as the base address */
#define BitIoLdd4_PORTCONTROL_BASE_ADDRESS PORTE_BASE_PTR /*!< Name of macro used as the base address */
#define BitIoLdd4_PORT_MASK 0x01U      /*!< Mask of the allocated pin from the port */
