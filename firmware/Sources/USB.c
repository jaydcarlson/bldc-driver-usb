...
static const DeviceDescriptor deviceDescriptor = {
   ...
   CONST_NATIVE_TO_LE16(0x04D8),         // idVendor           = Vendor ID
   CONST_NATIVE_TO_LE16(0x0053),        // idProduct          = Product ID
...
static const MS_PropertiesFeatureDescriptor msPropertiesFeatureDescriptor = {
    ...
    // {'{','5','8','d','0','7','2','1','0','-','2','7','c','1','-','1','1','d','d','-','b','d','0','b','-','0','8','0','0','2','0','0','c','9','a','6','6','}',0x0000}  
                               "{\000"  
                               "5\0008\000d\0000\0007\0002\0001\0000\000"
                               "-\0002\0007\000C\0001\000"
                               "-\0001\0001\000D\000D\000"
                               "-\000B\000D\0000\000B\000"
                               "-\0000\0008\0000\0000\0002\0000\0000\000C\0009\000A\0006\0006\000"
                               "}\000"
}; 
...
static const uint8_t sd1[] = "UNL Robotics";                        // Manufacturer
static const uint8_t sd2[] = "BLDC Motor controller";           // Product Description
static const uint8_t sd3[] = "BLDC000001";                    // Serial Number
static const uint8_t sd4[] = "BLDC Motor";        // Interface Association #1
static const uint8_t sd5[] = "BLDC Motor WinUSB";        // Interface #0
static const uint8_t sd6[] = "BLDC CDC Interface";        // Interface Association #2
...
static void initialiseEndpoints(void) {
   ...
   USB0_ENDPT1  = USB_ENDPT_EPRXEN_MASK|USB_ENDPT_EPTXEN_MASK|USB_ENDPT_EPHSHK_MASK; // Tx/Rx
